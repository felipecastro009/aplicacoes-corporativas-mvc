...
{!! Form::open(['method' => 'POST', 'novalidate', 'role' => 'form', 'class' => 'form', 'route' => 'admin.users.store', 'files' => true]) !!}
            ...
            <div class="row">
              <div class="col-sm-12 col-md-12">
                <div class="form-group mb-4">
                  ...
                  {!! Form::select('role', $roles, old('role'), ['class' => 'form-control', 'placeholder' => 'Selecione']) !!}
                  @if($errors->has('role'))
