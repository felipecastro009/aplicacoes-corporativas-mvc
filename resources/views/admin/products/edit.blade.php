...
@section('content')
  ...
  {!! Form::model($result, ['method' => 'PUT', 'novalidate', 'role' => 'form', 'class' => 'form', 'route' => ['admin.products.update', 'id' => $result->id, 'files' => true]]) !!}
  <section class="section">
    <div class="section-header mb-0">
      ...
      {!! Breadcrumbs::render('products.edit', $result) !!}
    </div>
